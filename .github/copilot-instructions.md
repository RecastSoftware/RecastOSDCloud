...
public/          # Exported cmdlets
  WinOS/         # Loaded in all environments
  WinPE/         # Loaded ONLY when SystemDrive == X: (WinPE)
...
3. Dot-source `private/**/*.ps1`; dot-source `public/WinOS/**/*.ps1`; if WinPE, also `public/WinPE/**/*.ps1`
